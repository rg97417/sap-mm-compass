...
5. **Auditoria:** grava ID, horário, chamado, classificação, resposta e fontes em JSONL local. Para uso real, seria necessário mascaramento, retenção e controle de acesso definidos pelo cliente.
